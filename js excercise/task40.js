...
console.log(make_album("Atif Aslam", "Pakistani singer-songwriter"));
console.log(make_album("Abida Parveen",  "Pakistani singer"));
console.log(make_album("Rahat Fateh Ali Khan", "Pakistani singer"));
...
function make_album(Num_tracks=""){
